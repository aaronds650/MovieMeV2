...
const MAX_REQUESTS_PER_WINDOW = 20; // Higher limit for conversation prompts
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const { systemMessage, prompt, model = "gpt-4-turbo-preview", temperature = 0.7, max_tokens = 150 } = req.body;
